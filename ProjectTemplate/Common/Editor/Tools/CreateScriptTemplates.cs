...
namespace Slayground.Common.Editor.Tools
{
    public static class CreateScriptTemplates
    {
        ...
        {
            string templatePath = "Assets/Common/Editor/ScriptTemplates/MonoBehaviour.cs.txt";
        ...
        {
            string templatePath = "Assets/Common/Editor/ScriptTemplates/Class.cs.txt";
        ...
        {
            string templatePath = "Assets/Common/Editor/ScriptTemplates/Enum.cs.txt";
        ...
        {
            string templatePath = "Assets/Common/Editor/ScriptTemplates/Struct.cs.txt";
        ...
        {
            string templatePath = "Assets/Common/Editor/ScriptTemplates/ScriptableObject.cs.txt";
        ...
        {
            string templatePath = "Assets/Common/Editor/ScriptTemplates/Singleton.cs.txt";
